...
<!--          </v-tab>-->
    ...
    <div class="rowCard" style="margin-top: 22px">
      <v-row class="d-flex align-center justify-center mx-10" id="nftlistshow" v-if="nftList.length !== 0"
      >
...
export default {
  name: "NFT",
  props: ["userData", "selectedBtn","type"],
  components: {
    Overlay,
    "show-case": ShowCase,
  ...
  computed: {
    ...
    tabNum() {
      return {
        ...
        notCreator: [
          {status: 0}, //"all",
          {is_onsale: true, status: 0}, //"onSale",
          {is_onsale: false, status: 0}, //"notSold",
          // {is_onsale: false, expiration: getNow, status: 0}, //"expire",
          {tabs: 'offers', is_redeem: false, offer_user: this.$route.params.id, status: 0}, //"offer",
          {
            tabs: 'bids',
            is_redeem: false,
            is_onsale: true,
